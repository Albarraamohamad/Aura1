    ...
    <footer className="bg-white text-black">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-8 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 md:gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-4 sm:mb-6 font-light text-sm sm:text-base">
            ...
            <a 
              href="#" 
              className="inline-flex items-center gap-2 text-black border-b border-black pb-1 hover:opacity-70 transition-opacity text-sm sm:text-base"
            >
            ...
            <div className="flex gap-3 sm:gap-4 mt-6 sm:mt-8">
              <a 
                href="#" 
                className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border border-gray-300 flex items-center justify-center hover:bg-black hover:text-white transition-all"
              >
                <Facebook size={16} />
              </a>
              <a 
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li>
                <a href="#" className="text-gray-600 hover:text-black transition-colors font-light text-sm sm:text-base">
                  About us
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="bg-gray-100 rounded-full p-1 flex flex-col sm:flex-row items-stretch sm:items-center">
              <input
                type="email"
            ...
            <div className="mt-6 sm:mt-8 flex items-center gap-2">
              <div className="bg-gray-100 backdrop-blur-sm px-3 sm:px-5 py-1 sm:py-2 rounded-lg border border-gray-300">
      ...
      <div className="border-t border-gray-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 py-4 sm:py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-xs sm:text-sm font-light text-center md:text-left">
            © 2025 RIGHTS RESERVED TO <span className="font-normal text-black">AURA</span>
          </p>
          
          {/* Payment Methods */}
          <div className="flex gap-2 sm:gap-3 flex-wrap justify-center md:justify-end">
            <div className="bg-gray-100 rounded-lg px-2 sm:px-4 py-1 sm:py-2 shadow-sm">
              <span className="text-blue-600 font-bold text-xs sm:text-sm">VISA</span>
            </div>
            <div className="bg-gray-100 rounded-lg px-2 sm:px-4 py-1 sm:py-2 shadow-sm flex items-center">
      ...
      <button 
        ...
        className="fixed bottom-4 sm:bottom-8 right-4 sm:right-8 bg-black text-white w-10 h-10 sm:w-12 sm:h-12 rounded-full shadow-lg hover:shadow-2xl hover:scale-110 transition-all flex items-center justify-center group z-50"
      >
        <svg 
