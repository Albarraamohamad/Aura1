...
export default function AuraNav() {
  ...
  return (
    <nav
      ref={navRef}
      className="relative flex items-center  justify-between  py-20 text-black bg-transparent z-50 pointer-events-auto"
    >
      {/* Mobile Menu Button */}
      <button
      ...
      <div
        ref={logoRef}
        className="absolute left-1/2 top-6 -translate-x-1/2 text-center z-50"
      >
        <div className="text-xs tracking-wider mb-1">BY</div>
        <div className="text-3xl md:text-4xl lg:text-5xl font-serif">aura.</div>
